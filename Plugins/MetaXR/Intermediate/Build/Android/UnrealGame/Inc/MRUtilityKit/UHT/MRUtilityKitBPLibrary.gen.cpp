...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMRUKLoadFromJson_LoadSceneFromJsonAsync_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMRUKLoadFromJson, nullptr, "LoadSceneFromJsonAsync", nullptr, nullptr, Z_Construct_UFunction_UMRUKLoadFromJson_LoadSceneFromJsonAsync_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMRUKLoadFromJson_LoadSceneFromJsonAsync_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMRUKLoadFromJson_LoadSceneFromJsonAsync_Statics::MRUKLoadFromJson_eventLoadSceneFromJsonAsync_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMRUKLoadFromJson_LoadSceneFromJsonAsync_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMRUKLoadFromJson_LoadSceneFromJsonAsync_Statics::Function_MetaDataParams) };
...
DEFINE_FUNCTION(UMRUKLoadFromJson::execLoadSceneFromJsonAsync)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	*(UMRUKLoadFromJson**)Z_Param__Result=UMRUKLoadFromJson::LoadSceneFromJsonAsync(Z_Param_WorldContext,Z_Param_JsonString);
	P_NATIVE_END;
}
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UMRUKLoadFromJson);
UClass* Z_Construct_UClass_UMRUKLoadFromJson_NoRegister()
{
	return UMRUKLoadFromJson::StaticClass();
}
struct Z_Construct_UClass_UMRUKLoadFromJson_Statics
{
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UMRUKLoadFromJson_LoadSceneFromJsonAsync, "LoadSceneFromJsonAsync" }, // 1893470715
		{ &Z_Construct_UDelegateFunction_UMRUKLoadFromJson_MRUKLoaded__DelegateSignature, "MRUKLoaded__DelegateSignature" }, // 1264035588
		{ &Z_Construct_UFunction_UMRUKLoadFromJson_OnSceneLoaded, "OnSceneLoaded" }, // 2794970876
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
template<> MRUTILITYKIT_API UClass* StaticClass<UMRUKLoadFromJson>()
{
	return UMRUKLoadFromJson::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitBPLibrary_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		...
		{ Z_Construct_UClass_UMRUKLoadFromJson, UMRUKLoadFromJson::StaticClass, TEXT("UMRUKLoadFromJson"), &Z_Registration_Info_UClass_UMRUKLoadFromJson, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMRUKLoadFromJson), 1683460316U) },
		{ Z_Construct_UClass_UMRUKBPLibrary, UMRUKBPLibrary::StaticClass, TEXT("UMRUKBPLibrary"), &Z_Registration_Info_UClass_UMRUKBPLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMRUKBPLibrary), 590302321U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitBPLibrary_h_3372114529(TEXT("/Script/MRUtilityKit"),
	Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitBPLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitBPLibrary_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitBPLibrary_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitBPLibrary_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
