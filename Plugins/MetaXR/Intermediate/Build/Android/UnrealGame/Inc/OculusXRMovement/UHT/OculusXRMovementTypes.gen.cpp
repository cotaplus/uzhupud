...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_OculusXRFaceVisemesState;
class UScriptStruct* FOculusXRFaceVisemesState::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_OculusXRFaceVisemesState.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_OculusXRFaceVisemesState.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FOculusXRFaceVisemesState, (UObject*)Z_Construct_UPackage__Script_OculusXRMovement(), TEXT("OculusXRFaceVisemesState"));
	}
	return Z_Registration_Info_UScriptStruct_OculusXRFaceVisemesState.OuterSingleton;
}
template<> OCULUSXRMOVEMENT_API UScriptStruct* StaticStruct<FOculusXRFaceVisemesState>()
{
	return FOculusXRFaceVisemesState::StaticStruct();
}
...
{
	if (!Z_Registration_Info_UScriptStruct_OculusXRFaceVisemesState.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_OculusXRFaceVisemesState.InnerSingleton, Z_Construct_UScriptStruct_FOculusXRFaceVisemesState_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_OculusXRFaceVisemesState.InnerSingleton;
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Documentos_Trabajos_ArchVizFernando_ArchViz_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRMovementTypes_h_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		...
		{ FOculusXRFaceVisemesState::StaticStruct, Z_Construct_UScriptStruct_FOculusXRFaceVisemesState_Statics::NewStructOps, TEXT("OculusXRFaceVisemesState"), &Z_Registration_Info_UScriptStruct_OculusXRFaceVisemesState, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOculusXRFaceVisemesState), 3194812747U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Documentos_Trabajos_ArchVizFernando_ArchViz_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRMovementTypes_h_3698063359(TEXT("/Script/OculusXRMovement"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Documentos_Trabajos_ArchVizFernando_ArchViz_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRMovementTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Documentos_Trabajos_ArchVizFernando_ArchViz_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRMovementTypes_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Documentos_Trabajos_ArchVizFernando_ArchViz_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRMovementTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Documentos_Trabajos_ArchVizFernando_ArchViz_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRMovementTypes_h_Statics::EnumInfo));
// End Registration
